...
// values given the total number of records, current page, and page size value. Note
...
// nyphen character (if the exists).
...
// Return the sort direction ("ASC", "DESC") depending on the prefix character of the
// Sort field.
