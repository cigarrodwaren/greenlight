...
// Declare a custom Runtime type, which has the inderlying type int32 (the same as our
// Movie struct field).
type Runtime int32

// Implement a MarshalJSON() method on the Rutime type so that is satisfies the
// json.Matshaler interface. This should return the JSON-encoded value for the movie
...
func (r *Runtime) UnmarshalJSON(jsonValue []byte) error {
	...
	// double-quotes from this string. If we can't unquote it, thenwe return the
